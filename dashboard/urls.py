...
urlpatterns = [
    ...
    path('hero/logos/reorder/', views.reorder_hero_logos, name='reorder_hero_logos'),
    path('hero/buttons/reorder/', views.reorder_hero_buttons, name='reorder_hero_buttons'),
